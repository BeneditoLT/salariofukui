function  calcular(){
    ...
    var sahirkin = ((Number(salHor.value)*8.33333)+ ((Number(salHor.value)*1.25)*2)) * Number(hirkin.value)
    var sayakin = ((Number(salHor.value)*3.16666) + ((Number(salHor.value)*1.25)*7.33333)) * Number(yakin.value)
    var sahirkindo = ((((Number(salHor.value)*1.35)*8.33333)+ ((Number(salHor.value)*1.6)*2)) * Number(hirkindo.value)) 
    var sayakindo = ((((Number(salHor.value)*1.35)*3.16666) + ((Number(salHor.value)*1.6)*7.33333)) * Number(yakindo.value))
