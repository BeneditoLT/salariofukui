function  calcular(){
    ...
    var sahirkin = ((Number(salHor.value)*8.8 + ((Number(salHor.value)*1.25)*2)) * Number(hirkin.value))
    var sayakin = ((Number(salHor.value)*1.5 + ((Number(salHor.value)*1.25)*9.3)) * Number(yakin.value))
    var sahirkindo = ((((Number(salHor.value)*1.35)*8.8)+ ((Number(salHor.value)*1.6)*2)) * Number(hirkindo.value)) 
    var sayakindo = ((((Number(salHor.value)*1.35)*1.5) + ((Number(salHor.value)*1.6)*9.3)) * Number(yakindo.value))
    var sayukil = ((Number(salHor.value)*8.8) * Number(yukyu.value))
